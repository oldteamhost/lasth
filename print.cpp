...
void print::printHelpMenu()
{
    ...
    std::cout << "                        [-t TIMEOUT] [-p PROTC://IP:PORT]\n";
    std::cout << "                        [--html] [--ru] [--color] [--code CODE]\n\n\n";
    ...
    std::cout << "  --code                Specify your correct answer code.\n";
...
void print::printHelpMenuRu()
{
    ...
    std::cout << "\nюзать: ./lstn <ЦЕЛЬ> [-h] [--version] [--txt] [-d]\n";
    std::cout << "                      [-t МС] [-p ПРОТЛ://АЙПИ:ПОРТ]\n";
    std::cout << "                      [--html] [--ru] [--color] [--code КОД]\n\n\n";
    ...
    std::cout << "  --code                Указать свой правильный код ответа.\n";
...
void print::printError(std::string temp, int mode)
{
    ...
    else if (mode == 3)
    {
        if (colorActive)
        {
            std::cout << bold << bright_red << "[-]" << reset << temp;
        }
        else
        {
            std::cout << "[-]" << temp;
